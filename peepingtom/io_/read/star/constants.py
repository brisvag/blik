from ...utils.eulerangle_helper import EulerAngleConvention
...
star_types = {
    'dynamo': {
        ...
        'angle_convention': EulerAngleConvention(axes='zxz', intrinsic=False, positive_ccw=True,
    ...
    'relion': {
        ...
        'angle_convention': EulerAngleConvention(axes='zyz', intrinsic=True, positive_ccw=True,
                                                 rotate_reference=False),
        'split_by': 'rlnMicrographName',
    },
    'relion_2d': {
