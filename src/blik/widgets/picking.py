...
from morphosamplers.samplers.sphere_samplers import PoseSampler, PointSampler
...
def sphere_particles(
    ...
    features = pd.DataFrame({"orientation": np.asarray(Rotation.from_matrix(invert_xyz(poses.orientations)))})
